...
var myApp = angular.module('myApp', ['myApp.filters', 'myApp.services', 'myApp.directives','ajoslin.mobile-navigate','ngMobile'])
    ...
    .config(['$routeProvider', function($routeProvider) {
        ...
        $routeProvider.when('/view1', {templateUrl: 'partials/presentationView.html', controller: 'HomeCtrl'});
        ...
        $routeProvider.when('/view12', {templateUrl: 'partials/tempView.html', controller: 'HomeCtrl',});
